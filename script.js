  ...
  const quiz = {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ["се отделят опиумоподобни пептдидни вещества: ендорфини и енкефалини, произвеждащи се в хипофизата, които, свързвайки се със съответните мозъчни рецептори, упражняват успокоителен и обезболяващ ефект", "Рязко започва да се понижава концентрацията на лактат (млечна киселина)  в кръвта", "намялява оксидативният капацитет на мускулите"],
        ...
        wrongGif:
          "https://hips.hearstapps.com/hmg-prod/images/pushup-1462808858.gif", // Path to the GIF for wrong answer
      ...
      },
      {
        ...
        options: ["“празни” калории", "„богати“ калории", "„важни“ калории"],
        answer: '“празни” калории',
        wrongAnswerText: "Грешен отговор, направете 20 скални катерача",
        wrongGif:
          "https://i.pinimg.com/originals/0b/3c/b4/0b3cb465e4a3a09139819e0bce4036a0.gif", // Path to the GIF for wrong answer
      ...
      },
      {
        ...
        options: ["тъй като могат да се натрупват в организма във формата на глюкоза","доставят бърза енергия на организма","водят до бързо покачване на кръвната захар"],
      ...
      },
      {
        ...
        options: ['30ml на килограм телесно тегло','20ml на килограм телесно тегло','10ml на килограм телесно тегло'],
      ...
      },
      {
        ...
        options: ['при което дейността на някои нервни центрове помага за премахване на умората в други центрове','спиране на всякакви специални движения (почивка, докато стоите, седите, лежите)','3-5 минути масаж са еквивалентни на 20-30 минути пасивна почивка'],
