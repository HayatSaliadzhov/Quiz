document.addEventListener("DOMContentLoaded", function () {
    ...
    questions: [
      {
        ...
        wrongAnswerText: "Грешен отговор, направете 5 бърпита",
        wrongGif:
        ...
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRPNOjm-_gIUA-BPSTA1XUlhviMt6U9QiauR3TYvQANA&s",
      },
      {
        text: "По време на физическо натоварване:",
        options: [
          "Рязко започва да се понижава концентрацията на лактат (млечна киселина)  в кръвта",
          "намялява оксидативният капацитет на мускулите",
          "се отделят опиумоподобни пептдидни вещества: ендорфини и енкефалини, произвеждащи се в хипофизата, които, свързвайки се със съответните мозъчни рецептори, упражняват успокоителен и обезболяващ ефект",
        ],
        answer:
          "се отделят опиумоподобни пептдидни вещества: ендорфини и енкефалини, произвеждащи се в хипофизата, които, свързвайки се със съответните мозъчни рецептори, упражняват успокоителен и обезболяващ ефект",
        wrongAnswerText: "Грешен отговор, направете 10 лицеви опори ",
        wrongGif:
          "https://hips.hearstapps.com/hmg-prod/images/pushup-1462808858.gif",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoOWsqiPCbOgZtX2_I883L3egnu5JSKjQre1oi3oLxww&s",
      },
      {
        ...
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTIYaCuFODCc3YkmXtIL6G5cfFCnqEKc-FUG50cg0stWw&s",
      },
      {
        text: "Сложните въглехидрати се считат за висококачествени храни:",
        options: [
          "доставят бърза енергия на организма",
          "водят до бързо покачване на кръвната захар",
          "тъй като могат да се натрупват в организма във формата на глюкоза",
        ],
        answer:
          "тъй като могат да се натрупват в организма във формата на глюкоза",
        wrongAnswerText: "Грешен отговор, направете 20 коремни преси",
        wrongGif:
          "https://i.pinimg.com/originals/fb/7d/88/fb7d88e46efd63d70963c84c02974414.gif",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSGlDAgGXbQzeBBhhtSN9wn0o6RRZwZ7ZcCEJNout1FlA&s",
      },
      {
        text: "„Основното гориво” за мускулите по време на физическо натоварване е?",
        options: ["гликогенът", "кислородът", "body mass index, BMI"],
        answer: ["гликогенът"],
        wrongAnswerText: "Грешен отговор, направете 30 секунди планк",
        wrongGif: "https://cdn.jefit.com/assets/img/exercises/gifs/631.gif",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzL3Y-usk8wI94f1tzL1ubw1pyowmJHSJpeoavn3h1PQ&s",
      },
      {
        text: "Извън тренировъчната залата препоръчително е поеманата вода да е:",
        options: [
          "20ml на килограм телесно тегло",
          "30ml на килограм телесно тегло",
          "10ml на килограм телесно тегло",
        ],
        answer: "30ml на килограм телесно тегло",
        wrongAnswerText: "Грешен отговор, направете 15 клека",
        wrongGif:
          "https://i0.wp.com/b-reddy.org/wp-content/uploads/2021/01/Squat-GIF.gif?fit=860%2C860&ssl=1&w=640",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTx52q7J1xMw9rhpr8v68NsGm9nIAZivNakMAoCWw_UHg&s",
      },
      {
        text: "Водата (H2O) като основно хранително вещество изпълнява пластична функция. Колко процента е водата в човешкото тяло?",
        options: [
          "около 65% от телесната маса е вода",
          "около 35% от телесната маса е вода",
          "около 85% от телесната маса е вода",
        ],
        answer: "около 65% от телесната маса е вода",
        wrongAnswerText: "Грешен отговор, направете обиколка на залата",
        wrongGif:
          "https://i.pinimg.com/originals/f9/2e/1b/f92e1bb2a6789fff27bfd483145e0efc.gif",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgB4ywWeEDQjYvIe4h97FBHsJclRcgJE1x8QbI2NWCrw&s",
      },
      {
        text: "Активната почивка се основава на явлението:",
        options: [
          "спиране на всякакви специални движения (почивка, докато стоите, седите, лежите)",
          "3-5 минути масаж са еквивалентни на 20-30 минути пасивна почивка",
          "при което дейността на някои нервни центрове помага за премахване на умората в други центрове",
        ],
        answer:
          "при което дейността на някои нервни центрове помага за премахване на умората в други центрове",
        wrongAnswerText: "Грешен отговор, направете 15 Jumping Jacks",
        wrongGif:
          "https://www.icegif.com/wp-content/uploads/jumping-jacks-icegif-5.gif",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgEZgUNGXCOLw-mc0ATw5QHmuAzs1Vy4gnBIPZZIxbjQ&s",
      },
      {
        ...
        options: [
          "символизира петте континента - Участието на атлети от всички населени континенти: Северна Америка, Южна Америка, Африка, Евразия и Океания",
          "Олимпиади се провеждат на всеки 5 години",
          "Възможност за участие на състезател в до пет спорта.",
        ],
        answer:
          "символизира петте континента - Участието на атлети от всички населени континенти: Северна Америка, Южна Америка, Африка, Евразия и Океания",
        wrongAnswerText: "Грешен отгвор, направете 20 sitting twitsts",
        wrongGif:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRq5bJmXXsM-h4lNkkpLi1gVH0aYxwet7iEtB_nRsmREw&s",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5N4Nvco8q86KR8rrcQpw20DmbjWHBbrrMHHox9Lrh6w&s",
      },
    ],
  };
  ...
  function displayWrongAnswerModal(wrongAnswerText, wrongGif) {
    ...
    const wrongAnswerTextElement = document.querySelector(
      "#modal #wrong-answer-text"
    );
  ...
  function checkAnswer() {
    ...
    if (selectedOption) {
      ...
      if (currentQuestion.answer.includes(selectedAnswer)) {
        ...
        displayWrongAnswerModal(
          currentQuestion.wrongAnswerText,
          currentQuestion.wrongGif
        );
      }
    }
  }
  ...
  function showScore() {
    ...
    scoreImage.src =
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFKDyow2Mf8bpVKmzf5KHX8CtzQ6g_vjcIfivq79nUbA&s"; // Replace "score_image.jpg" with the path to your image
    ...
    scoreText.textContent =
      "Благодаря ви за участието! Резултат: " +
      totalScore +
      "/" +
